...
const Tenders: React.FC<TendersProps> = ({ onSubmit, isAuthenticated, onLoginRequired }) => {
  ...
  // Get upcoming tenders for the Future Tenders section
  const futureTenders = tenders.filter(tender => tender.status === 'upcoming');
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div>
            ...
            <div className="mt-12 mb-12">
              <h2 className="text-2xl font-bold text-white mb-6">Future Tenders</h2>
              <p className="text-gray-400 mb-8">Upcoming tender opportunities that will be open for bidding soon</p>
              
              {futureTenders.length === 0 ? (
                <div className="bg-secondary-dark rounded-lg p-8 text-center">
                  <p className="text-xl text-white font-medium mb-4">No future tenders available at this time</p>
                  <p className="text-gray-400">Check back later for upcoming opportunities</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    >
                      <div className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
                          ...
                          <div>
                            <p className="text-gray-500">Opens On</p>
                            <p className="text-white">{formatDeadline(tender.submissionDeadline)}</p>
                          </div>
                          <div>
                            <p className="text-gray-500">Location</p>
                            <p className="text-white">{tender.location}</p>
                        ...
                        <div className="mt-4">
                          <button
                            onClick={() => {
                              if (isAuthenticated) {
                                onNotify ? onNotify(`You will be notified when "${tender.title}" opens for bidding`) : null;
                              } else {
                                onLoginRequired();
                              }
                            }}
                            className="w-full px-3 py-2 bg-blue-600/20 text-blue-400 rounded-md text-sm font-medium hover:bg-blue-600/30 transition-colors flex items-center justify-center"
                          >
